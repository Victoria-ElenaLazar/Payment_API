...
class DeactivateCustomerController extends A_Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/v1/customer/deactivate/{id}",
     *     description="Deactivates a particular customer based on its ID",
     *     @OA\Parameter(
     *          description="ID of a customer to be deactivated",
     *          in="path",
     *          name="id",
     *          required=true,
     *          @OA\Schema(
     ...
     * @return Response
     */
    public function deactivateAction(Request $request, Response $response, $args): ResponseInterface
    {
