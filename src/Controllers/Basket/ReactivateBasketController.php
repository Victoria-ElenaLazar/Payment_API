...
class ReactivateBasketController extends A_Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/v1/basket/reactivate/{id}",
     *     description="Reactivates a particular basket based on its ID",
     *     @OA\Parameter(
     *          description="ID of a basket to be reactivated",
     *          in="path",
     *          name="id",
     *          required=true,
     *          @OA\Schema(
     ...
     * @OA\Response(
     *           response=200,
     *           description="Basket has been reactivated successfully",
     *       ),
     * @OA\Response(
     *           response=400,
