...
class ReactivateTransactionController extends A_Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/v1/transaction/reactivate/{id}",
     *     description="Reactivates a particular transaction based on its ID",
     *     @OA\Parameter(
     *          description="ID of a transaction to be reactivated",
     *          in="path",
     *          name="id",
     *          required=true,
     *          @OA\Schema(
     ...
     * @OA\Response(
     *           response=200,
     *           description="Transaction has been reactivated successfully",
     *       ),
     * @OA\Response(
     *           response=400,
     ...
     */
    public function reactivateAction(Request $request, ResponseInterface $response, $args): ResponseInterface
    {
